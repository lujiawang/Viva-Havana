...
namespace Passer {
    ...
    public class FootTarget : HumanoidTarget {
        ...
        private UnityLegSensor[] _sensors;
        public UnityLegSensor[] sensors {
            get {
                if (_sensors == null)
                    InitSensors();
                return _sensors;
        ...
        public void CheckGrounded() {
            ...
            groundDistance = humanoid.GetDistanceToGroundAt(checkStartPosition, humanoid.stepOffset * 2, out ground, out groundNormal);
