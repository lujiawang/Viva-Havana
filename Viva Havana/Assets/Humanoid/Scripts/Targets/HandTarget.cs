...
namespace Passer {
    ...
    public class HandTarget : HumanoidTarget {
        ...
        private UnityArmSensor[] _sensors;
        public UnityArmSensor[] sensors {
            get {
                if (_sensors == null)
                    InitSensors();
                return _sensors;
        ...
        public class TargetedForearmBone : TargetedBone {
            ...
            public override Quaternion DetermineRotation() {
                ...
                Vector3 rotationAxis = angle > 0 ? Vector3.Cross(upperArmBoneDirection, forearmBoneDirection) : handTarget.humanoid.up;
        ...
        public override void UpdateTarget() {
            ...
            HandInteraction.CheckLetGo(this);
            poseMixer.ShowPose(humanoid, isLeft ? Side.Left : Side.Right);
#if LIB
            arm.SetTargets(this);
#endif
