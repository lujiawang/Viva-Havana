...
namespace Passer {
    ...
    public class HumanoidControl_Editor : Editor {
        ...
        protected SerializedProperty stepOffsetProp;
        ...
        private SerializedProperty bodyPullProp;
        ...
        private SerializedProperty disconnectInstancesProp;
        ...
        private void InitSettings() {
            ...
            bodyPullProp = serializedObject.FindProperty("bodyPull");
            ...
            disconnectInstancesProp = serializedObject.FindProperty("disconnectInstances");
        }
        ...
        private void DisconnectInstancesSetting() {
            GUIContent text = new GUIContent(
