        ...
        public class TrackerProps : HumanoidControl_Editor.HumanoidTrackerProps {
            ...
            public override void Inspector(HumanoidControl humanoid) {
                ...
                if (oculusSupported) {
                    ...
                    deviceTypeProp.intValue = (int)(OculusTracker.AndroidDeviceType)EditorGUILayout.EnumPopup("Device Type", (OculusTracker.AndroidDeviceType)deviceTypeProp.intValue);
                    EditorGUI.indentLevel--;
#endif
                }
                else
