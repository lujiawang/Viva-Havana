...
namespace Passer.Humanoid {
    ...
    public class OpenVRController : SensorComponent {
        ...
        ulong actionHandle;
        [System.NonSerialized]
        Passer.InputSkeletalActionData_t tempSkeletonActionData = new Passer.InputSkeletalActionData_t();
        [System.NonSerialized]
        uint skeletonActionData_size;

        public const int numBones = 31;
        [System.NonSerialized]
        public Passer.VRBoneTransform_t[] tempBoneTransforms = new Passer.VRBoneTransform_t[numBones];
