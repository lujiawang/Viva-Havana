...
namespace Passer {
    ...
    public class ControllerSide {
        /// <summary>The vertical value of the thumbstick or touchpad</summary>
        /// Values: -1..1
        public float stickHorizontal;
        /// <summary>The horizontal value of the thumbstick or touchpad</summary>
        /// Values: -1..1
        public float stickVertical;
        /// <summary>The pressed state of the thumb stick or touchpad</summary>
        public bool stickButton;
        /// <summary>The touched state of the thumb stick or touchpad</summary>
