...
namespace Passer {
    ...
    public class InputEvent {
        ...
        public Object objParameter;

        public bool valueChanged;
        protected bool _intChanged;
        ...
        public virtual float floatValue {
            ...
            set {
                ...
                int newIntValue = (int)value;
                _intChanged = newIntValue != _intValue;
        ...
        public System.Type methodParameterType2; // type of the additional parameter
        ...
        public void DetermineMethodProperties() {
            ...
            if ((parameters.Length == 1 || parameters.Length == 2) && parameters[0].ParameterType.IsEnum) {
                ...
                enumParameter = false;
                methodParameterType = parameters[1].ParameterType;
                methodParameterType2 = parameters[0].ParameterType;
            }
            else if (parameters.Length == 1) {
                enumParameter = false;
                methodParameterType = parameters[0].ParameterType;
                methodParameterType2 = typeof(void);
            }
            else {
                enumParameter = false;
                methodParameterType = typeof(void);
            ...
            switch (methodParameterCount) {
                ...
                case 2:
                    if (enumParameter && enumVal > -1) {
                        ...
                        if (methodParameterType == typeof(float))
                            InvokeObjectFloatMethod(target);
                        else if (methodParameterType == typeof(int))
                            InvokeObjectIntMethod(target);
                        else if (methodParameterType == typeof(bool))
                            InvokeObjectBoolMethod(target);
                    }
                    break;
            }
        }
        ...
        #region 2 arguments with Object
        protected virtual void InvokeObjectGameObjectMethod(Object target) {
            if (targetMethod == null)
                return;

            InvokeMethod(() => targetMethod.Invoke(target, new object[] { objParameter, _floatValue }));
        }

        protected void InvokeObjectFloatMethod(Object target) {
            if (targetMethod == null)
                return;
        ...
        protected void InvokeObjectIntMethod(Object target) {
            if (targetMethod == null)
                return;

            InvokeMethod(() => targetMethod.Invoke(target, new object[] { objParameter, _intValue }));
        }

        protected void InvokeObjectBoolMethod(Object target) {
            if (targetMethod == null)
                return;

            InvokeMethod(() => targetMethod.Invoke(target, new object[] { objParameter, _boolValue }));
        }
        #endregion
