...
namespace Passer {
    public class InteractionPointer : MonoBehaviour {
        ...
        protected virtual void Awake() {
            ...
            // Cannot enable this yet, because Interaction Pointer requires an EventSystem at the moment.

            //// Only humanoid Interactions have eventsystems
            //EventSystem eventSystem = rootTransform.GetComponent<EventSystem>();
            //if (eventSystem != null) {
            //    HumanoidControl humanoid = rootTransform.GetComponentInChildren<HumanoidControl>();
            //    if (humanoid == null)
            //        Destroy(eventSystem);
            //}
        ...
        protected virtual void Update() {
            ...
            if (inputModule.IsPointing(interactionID)) {
                ...
                if (rayType == RayType.SphereCast) {
                    ...
                    Vector3 focusPoint = inputModule.GetFocusPoint(interactionID);
