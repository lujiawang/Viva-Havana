...
namespace Passer.Humanoid {
    ...
    public class TeleportTarget : EventTrigger {
        ...
        /// <summary>
        /// Finds the first local Humanoid and teleports it to this Teleport Target
        /// </summary>
        public void TeleportLocalHumanoid() {
            HumanoidControl humanoid = FindLocalHumanoid();
            if (humanoid != null)
                TeleportToHere(humanoid);
        }
        ...
        protected HumanoidControl FindLocalHumanoid() {
