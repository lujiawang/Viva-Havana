...
namespace Passer {
    ...
    public class LegAnimator : UnityLegSensor {
        ...
        public override void Update() {
            ...
            leftAnimator = footTarget.humanoid.leftFootTarget.animator;
            rightAnimator = footTarget.humanoid.rightFootTarget.animator;
        ...
        private void CheckTranslation() {
            ...
            if (com2Foot.magnitude > 0.10F && footTarget.humanoid.ground != null) {
                ...
                else if (!footTarget.animator.movedLast) {
        ...
        public Vector3 GetCurrentPosition(Vector3 step, float fWithinFrame, int prevFrame, int nextFrame) {
            ...
            if (scale == 0 || step.sqrMagnitude == 0) {
