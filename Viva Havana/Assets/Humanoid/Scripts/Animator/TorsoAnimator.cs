...
namespace Passer {
    ...
    public class TorsoAnimator : UnityTorsoSensor {
        ...
        public override void Update() {
            if (!hipsTarget.humanoid.animatorEnabled || !enabled ||
                hipsTarget.humanoid.targetsRig == null || hipsTarget.humanoid.targetsRig.runtimeAnimatorController != null)
                return;
        ...
        private void UpdateHipsPosition() {
            ...
            hipsNeckRotation = Quaternion.identity;

            Quaternion hipsHeightRotation = CalculateHipsHeightRotation(humanoid);

            Vector3 torsoVector = Vector3.down * torsoLength;
