...
namespace Passer {
    ...
    public class ArmAnimator : UnityArmSensor {
        ...
        public override void Update() {
            ...
            float avatarYangle = handTarget.humanoid.hipsTarget.hips.bone.targetRotation.eulerAngles.y;
            Quaternion avatarRotation = Quaternion.AngleAxis(avatarYangle, handTarget.humanoid.up);
