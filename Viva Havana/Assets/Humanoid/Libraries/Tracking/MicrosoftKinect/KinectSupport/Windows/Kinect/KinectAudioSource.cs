...
namespace Windows.Kinect
{
    ...
    //
    public sealed partial class KinectAudioSource : Helper.INativeWrapper

    {
        ...
        internal KinectAudioSource(RootSystem.IntPtr pNative)
        {
            _pNative = pNative;
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache.RemoveObject<KinectAudioSource>(_pNative);
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache.GetObject<KinectAudioSource>(pNative);
